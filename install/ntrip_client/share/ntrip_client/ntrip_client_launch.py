...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('host',                  default_value='RTS2.ngii.go.kr'), # <-- EDIT THIS
          DeclareLaunchArgument('port',                  default_value='2101'), # <-- EDIT THIS
          DeclareLaunchArgument('mountpoint',            default_value='VRS-RTCM32'), # <-- EDIT THIS
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'), # <-- EDIT THIS
          DeclareLaunchArgument('username',              default_value='jeanho1212'), # <-- EDIT THIS
          DeclareLaunchArgument('password',              default_value='ngii'), # <-- EDIT THIS
